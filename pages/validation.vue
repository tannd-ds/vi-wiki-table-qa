      ...
      <BaseBox class="w-[42rem] flex-col gap-4">
        ...
        >
          <div class="flex items-center gap-2">
            ...
            <h2 class="text-lg font-semibold text-yellow-500">Weird...</h2>
          </div>

          <span class="dark:text-gray-200"
            >Your 2 uploaded files have different name...</span
          >
          <ul
        ...
        <div class="flex">
          <div
            class="flex cursor-pointer items-center justify-center gap-2 rounded-lg border border-gray-300 px-4 py-2 text-xs font-bold hover:bg-gray-200 dark:border-zinc-700 dark:text-gray-200 dark:hover:bg-midnight-100"
