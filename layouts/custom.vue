<template>
  <div :class="{'dark': general_store.use_darkmode,}">
    ...
    <div class="h-screen flex items-center justify-start gap-4 mr-8">
      <BaseBox class="ml-4 px-[1em] py-4 flex-col gap-8">
        <NuxtLink :to="`/step_` + general_store.current_step" class="relative group">
          ...
          >
            ...
            <div class="w-auto min-w-max py-2 px-4 absolute top-0 left-14 text-white bg-midnight-500 rounded font-bold scale-0 group-hover:scale-100 transition-all duration-200">
        ...
        <div class="relative group">
          ...
          <div class="w-auto min-w-max py-2 px-4 absolute top-0 left-14 text-white bg-midnight-500 rounded font-bold scale-0 group-hover:scale-100 transition-all duration-200">All Comfirmed QA Pairs</div>
        </div>
      ...
      <div class="absolute w-full h-full bg-gradient-to-bl from-zinc-800 to-midnight-400 -z-50" > </div>
